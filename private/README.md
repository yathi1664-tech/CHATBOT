...
## Two-person room
- Maximum 2 simultaneous members.
- A third connection is rejected even with the correct password.
- Both active members receive an in-chat security alert when someone tries to enter a full room.
- Your own messages appear on the right; the other member's messages appear on the left.

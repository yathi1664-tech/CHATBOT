...
function notifyIncomingMessage(message){
  ...
  // System push is handled by the service worker/server. Keep only an in-app toast while this page is visible.
  if(document.visibilityState==='visible') showNotificationToast(`${sender}: ${String(body).slice(0,120)}`);
}

...
function renderMessage(message){const article=document.createElement('article');article.className=`message${ownedMessageIds.has(message.id)?' mine':''}`;article.dataset.messageId=message.id;article._messageData=message;
